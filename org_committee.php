...
<body>
  ...
  <div class="container-fluid mainbody">
    ...
    <section id="cs2">
      <div class="org_com_div">
        <br><br>
        <h1 style="font-weight: 500; color: brown;text-align: center;">ORGANIZING COMMITTEE</h2>
          <br>
          ...
          <br>
          <h1 style="font-weight: 500; color: brown;">Technical Program Committee:</h1>
          <br>
          ...
          <p>Vice-Chair (Activity), IEEE CS BDC</p><br><br>

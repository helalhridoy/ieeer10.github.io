            ...
            <nav class="navbar navbar-expand-xl my-navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <!-- <form class="form-inline my-2 my-lg-0">
                        <button class="header-btn my-2 my-sm-0" type="submit">Registration</button>
                    </form> -->
                </div>
            </nav>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-12">
                <div class="banner-con text-center">
                    <p style="font-weight: bold;" class="first-title">IEEE R10CS International Conference on Computing, Applications
                        and Systems (COMPAS 2023)</p>
                    <p class="banner-des">Date: November 25-26, 2023
                        Vanue: Dhaka, Bangladesh</p>
                    <a href="" target="" class="banner-btn">Digital Technologies for the Future World Emerging Science and Technologies</a>
                </div>
            </div>
        </div>
    </div> -->
